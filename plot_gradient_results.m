...
export_fig(fh_nmae, sprintf('figures/interp_gradient_nmae_%s.pdf', options.plot_mode));
...
%export_fig(fh_r2, sprintf('figures/interp_gradient_r2_%s.pdf', options.plot_mode));
...
export_fig(fh_md, sprintf('figures/interp_divergence_%s.pdf', options.plot_mode));
...
%export_fig(fh_mc, sprintf('figures/interp_curl_%s.pdf', options.plot_mode));
